...
Original file is located at
    https://colab.research.google.com/drive/1fhHfYjq87ZnxD6lccjURyctdFtq0EUTb
"""

# ============================================================
# SISTEMA INTEGRADO – RESORT ARENA AZUL
# Planeación, Registro, Costos/Ventas/Ganancias, Reportes, CSV
# ============================================================
...
# ---------------------------------------------------
# MÓDULO 3: COSTOS, VENTAS Y GANANCIAS (NUEVO)
# ---------------------------------------------------
...
def modulo_finanzas():
    ...
    print("---------------------------------------")
    print(f"TOTALES:      {total_costos}   {total_ventas}   {total_ganancias}")
...
# ---------------------------------------------------
# MÓDULO 4: ADMINISTRADOR / REPORTES
# ---------------------------------------------------
